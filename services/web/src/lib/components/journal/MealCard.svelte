...
<div class="bg-white rounded-2xl shadow-md border border-stone-100 overflow-hidden transition-all duration-300 hover:shadow-lg">
	...
	<div class="p-5">
		...
		{:else}
			...
			<div class="flex items-center justify-center gap-3 py-6 text-stone-500">
				<div class="animate-spin size-5 border-2 border-stone-300 border-t-stone-600 rounded-full"></div>
